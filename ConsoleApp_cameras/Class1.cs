...
namespace Microsoft.AspNetCore.WebUtilities
{
    ...
    public class MultipartReaderTests
    {
        ...
        private const string OnePartBody = "--9051914041544843365972754266\r\n" +
        ...
        private const string OnePartBodyWithoutFinalCRLF = "--9051914041544843365972754266\r\n" +
            "Content-Disposition: form-data; name=\"text\"\r\n" +
            "\r\n" +
            "text default\r\n" +
            "--9051914041544843365972754266--";
        ...
        {
            var stream = MakeStream(File.ReadAllText("response44406.txt")); 
            //var stream = MakeStream(ThreePartBody);
            var reader = new MultipartReader("--myboundary", stream);
